    ...
    <nav className={`${styles.paddingX} w-full flex itmes-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        <Link to="/" className="flex itmes-center gap-2" onClick={() => {
          ...
          <p className=' text-[18px] font-bold cursor-pointer '>Prabhat Sharma</p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          {navLinks.map((link) => (
            <li key={Link.id} className={`${active === link.title ? "text-white": "text-secondary"} hover:text-white text-[16px] 
